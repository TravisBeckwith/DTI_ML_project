...
### `ML_v9_beta.sh` — v1.5-ml-enhanced
...
```bash
./ML_v9_beta.sh -s sub-001 --omp-threads 8 --use-ml-registration --ml-method auto
```
...
```bash
./ML_v9_beta.sh --dry-run
```

### Resume after interruption
```bash
./ML_v9_beta.sh -s sub-001 --resume
```

### Skip optional stages
```bash
./ML_v9_beta.sh --skip-synb0 --skip-connectome
```
